...
vlog -work xpm -64 -incr -sv "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
...
vlog -work generic_baseblocks_v2_1_0 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_22 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/af2c/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_5 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
...
vlog -work axi_data_fifo_v2_1_21 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/54c0/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_23 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/bc0a/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
...
vlog -work floating_point_v7_1_11 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
...
vlog -work xlconcat_v2_1_4 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
...
vlog -work xlconstant_v1_1_7 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
...
vlog -work axi_protocol_converter_v2_1_22 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/5cee/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \

vlog -work axi_clock_converter_v2_1_21 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/1304/hdl/axi_clock_converter_v2_1_vl_rfs.v" \

vlog -work blk_mem_gen_v8_4_4 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
"../../../../rm_template.gen/sources_1/bd/design_1/ipshared/2985/simulation/blk_mem_gen_v8_4.v" \

vlog -work axi_dwidth_converter_v2_1_22 -64 -incr "+incdir+../../../../rm_template.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
