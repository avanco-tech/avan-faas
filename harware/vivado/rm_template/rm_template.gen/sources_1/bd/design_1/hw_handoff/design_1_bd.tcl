...
proc create_hier_cell_custom_logic { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk clk_to_rm
  create_bd_pin -dir O -type intr intr_user
  create_bd_pin -dir I -type rst rstn_to_user
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins rstn_to_user] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins floating_point_0/aresetn]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins intr_user] [get_bd_pins axi_intc_0/irq]
  connect_bd_net -net clk_to_rm [get_bd_pins clk_to_rm] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins floating_point_0/aclk]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_to_rm [ create_bd_port -dir I -type clk -freq_hz 100000000 clk_to_rm ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_HP0_FPD:M_AXI_HPM0_FPD} \
   CONFIG.ASSOCIATED_RESET {rstn_to_user} \
 ] $clk_to_rm
  set intr_user [ create_bd_port -dir O -from 0 -to 0 -type intr intr_user ]
  set rstn_to_user [ create_bd_port -dir I -from 0 -to 0 -type rst rstn_to_user ]
