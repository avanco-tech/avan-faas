...
################################################################
# This is a generated script based on design: rm_design
#
...
proc create_hier_cell_custom_logic { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 0 -to 0 -type rst aresetn_S_AXI_HP0
  create_bd_pin -dir I -type clk clk_extra_0
  create_bd_pin -dir I -type clk clk_extra_1
  create_bd_pin -dir I -type clk clk_extra_2
  create_bd_pin -dir I -type clk clk_main
  ...
  # Create instance: proc_sys_reset_0_extra_2, and set properties
  set proc_sys_reset_0_extra_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_0_extra_2 ]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins rstn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins proc_sys_reset_0_extra_2/ext_reset_in] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net M00_ACLK_1 [get_bd_pins clk_extra_2] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins proc_sys_reset_0_extra_2/slowest_sync_clk]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins aresetn_S_AXI_HP0] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins proc_sys_reset_0_extra_2/peripheral_aresetn]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins intr] [get_bd_pins axi_intc_0/irq]
  connect_bd_net -net clk_to_rm [get_bd_pins clk_main] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins floating_point_0/aclk] [get_bd_pins system_ila_0/clk]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_extra_0 [ create_bd_port -dir I -type clk -freq_hz 75000000 clk_extra_0 ]
  set clk_extra_1 [ create_bd_port -dir I -type clk -freq_hz 150000000 clk_extra_1 ]
  set clk_extra_2 [ create_bd_port -dir I -type clk -freq_hz 200000000 clk_extra_2 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_HP0_FPD} \
 ] $clk_extra_2
  set clk_main [ create_bd_port -dir I -type clk -freq_hz 100000000 clk_main ]
  set_property -dict [ list \
  ...
  connect_bd_net -net clk_100MHz [get_bd_ports clk_main] [get_bd_pins custom_logic/clk_main] [get_bd_pins dfx_axi_shutdown_man_1/clk]
  connect_bd_net -net clk_extra_0_1 [get_bd_ports clk_extra_0] [get_bd_pins custom_logic/clk_extra_0]
  connect_bd_net -net clk_extra_1_1 [get_bd_ports clk_extra_1] [get_bd_pins custom_logic/clk_extra_1]
  connect_bd_net -net clk_extra_2_1 [get_bd_ports clk_extra_2] [get_bd_pins custom_logic/clk_extra_2] [get_bd_pins dfx_axi_shutdown_man_0/clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins custom_logic/aresetn_S_AXI_HP0] [get_bd_pins dfx_axi_shutdown_man_0/resetn]
